...
const skills = [
  ...
  },
  {
    ...
    title: "JavaScript",
    description:
      "High-level, often just-in-time compiled language that conforms to the ECMAScript specification.",
  },
  {
    icon: SiReact,
    color: "#61DAFB",
  ...
  },
  {
    ...
    title: "Vercel",
    description:
      "Cloud platform for static sites and Serverless Functions that fits perfectly with your workflow.",
  },
  {
    icon: SiGit,
    color: "#F05032",
    title: "Git",
    description:
      "Distributed version control system to track changes in source code during software development.",
  },
];
    ...
    <div className="space-y-2 container px-4 sm:px-6 lg:px-8" ref={ref}>
      ...
      <div className="relative">
        <div className="hidden md:block">
          ...
          <div
            className="pointer-events-none absolute inset-y-0 left-0 w-1/6 bg-gradient-to-r from-neutral-50 via-transparent dark:from-neutral-950 
        dark:via-transparent"
          ></div>
          <div
            className="pointer-events-none absolute inset-y-0 right-0 w-1/6 bg-gradient-to-l from-neutral-50 via-transparent dark:from-neutral-950 
        dark:via-transparent"
          ></div>
        </div>
